...
export async function SiteFooter() {
  ...
  return <footer className="border-t border-border bg-background">
    ...
    <div className="mx-auto flex max-w-[1440px] flex-col gap-8 px-5 py-10 sm:px-10 md:flex-row md:items-center md:justify-between lg:px-16">
      ...
      <p className="text-xs text-muted-foreground">&copy; {new Date().getFullYear()} Papa&apos;s Tacos</p>
    </div>
  </footer>;
}